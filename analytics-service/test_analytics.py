...
def sample_transactions():
    return [
        TransactionPayload(date="2026-09-02", description="Tesco", category="Food", amount=-45.0),
        TransactionPayload(date="2026-09-03", description="Salary", category="Income", amount=2500.0),
        TransactionPayload(date="2026-09-04", description="Bus", category="Transport", amount=-15.0),
    ]
...
def test_forecast_spending_insufficient_data():
    single_tx = [TransactionPayload(date="2026-09-02", description="Tesco", category="Food", amount=-45.0)]
